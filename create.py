...
def create_mail_tm_account():
 ...
 The following function is commented out to avoid any interaction with Facebook API.
...
for i in range(int(input('[+] How Many Accounts You Want:  '))):
    ...
    if email and password and first_name and last_name and birthday:
        print(f'Created email: {email} with password: {password} and name: {first_name} {last_name}, birthday: {birthday}')
